...
.rccs {
  ...
  .rccs__card {
    ...
    .rccs__card--front, .rccs__card--back {
      ...
      background:  linear-gradient(77deg, rgba(89,89,89,1) 0%, rgba(137,137,137,1) 18%, rgba(172,172,172,1) 25%, rgba(204,204,204,1) 35%, rgba(197,197,197,1) 50%, rgba(96,96,96,1) 100%, rgba(208,208,208,1) 430%);
    ...
    .rccs__card--unknown > div {
      background: linear-gradient(77deg, rgba(89,89,89,1) 0%, rgba(137,137,137,1) 18%, rgba(172,172,172,1) 25%, rgba(197,197,197,1) 50%, rgba(96,96,96,1) 100%, rgba(208,208,208,1) 430%);
